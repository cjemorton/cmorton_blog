...
tags: [ruby, learning, tutorial, programming-basics]
excerpt: "Learning notes and code examples from exploring Ruby programming language fundamentals."
---

As I learn Ruby, here are some of my notes.
...
puts 10 % 3 #- Modulus operator. (10 divided by 3, returns the remainder.) => 1
```
...
> There are two basic types of numbers in Ruby.
> Integer numbers are whole numbers. => 20 or 21 or 22, etc.
> Decimal numbers are floating point numbers. => 22.1 or 22.5 or 22.7, etc.
> Integers and floats can be used inside Ruby "basically interchangeably," but there are two separate types.
> Ruby does distinguish between these two types: whole numbers vs. floating point numbers.
...
```
> Whenever you add, multiply, or divide two integers together, you always get an integer back.
> Whenever you use an integer and a floating point number together to do some operation, you always get a floating point back.
...
> use `gets.chomp()` to remove new line.
